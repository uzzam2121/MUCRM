      ...
      <Dialog
        ...
        <DialogActions className="mb-4 mr-7">
          <button
            ...
            variant="contained"
            type="reset"
            className="bg-sky-200 px-4 font-primary py-2 rounded-lg text-gray-500 mt-4 hover:text-white hover:bg-[#6c757d] border-[2px] border-secondary-gray hover:border-sky-200 transition-all">
            Cancel
          </button>
          <button
