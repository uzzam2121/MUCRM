    ...
    <div>
      <Dialog
        ...
        <DialogContent>
          ...
          <div className="md:flex text-[#f5f5f5]">
            ...
            <div className="flex flex-col md:w-5/12 w-full mt-12">
              <div className="bg-secondary-gray w-full md:mt-0 mt-8 px-4 py-4 flex flex-col gap-5 rounded-md">
                <div className="bg-sky-100 px-2 py-1 w-full rounded-lg">
