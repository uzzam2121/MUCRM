                ...
                isFetching
                    ...
                    <>
                        ...
                        <div className="columns-3">
                            <div className="flex justify-center text-sm font-thin text-sky-600">Period</div>
                            <div className="flex justify-center text-sm font-thin text-sky-600">Income</div>
                            <div className="flex justify-center text-sm font-thin text-sky-600">Expenses</div>
                        </div>
                    </>
            }
        </Box>
