      ...
      <div style={{ minWidth: "50vh", maxWidth: "60vh" }}>
        ...
        <div className="p-4 flex flex-col gap-4">
          ...
          <div className="flex gap-4 justify-end">
            <button
              variant="contained"
              className="bg-sky-200 px-4 py-2 rounded-lg text-gray-500 mt-4 hover:text-white hover:bg-[#6c757d] border-[2px] border-secondary-gray hover:border-sky-200 font-thin transition-all">
              Reset
            </button>
            <button
              variant="contained"
