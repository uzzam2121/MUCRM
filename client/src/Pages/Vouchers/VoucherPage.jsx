    ...
    <div ref={pdfRef} className="completePdfPage w-full flex justify-center ">
      <div className="w-[51rem] h-full pt-10 bg-white">
        ...
        <div className="flex justify-center pt-10">
          <QRCode value={`Name: ${voucher.clientName}\nPhone: ${voucher.phone}\nCNIC: ${voucher.CNIC}\nAmount Paid: ${voucher.paid}\nPurpose: This person has applied for the degree of ${voucher.degree == 'other' ? voucher.degreeName : voucher.degree} with major as ${voucher.major} in ${voucher.country}.`} size={128} />
        </div>
