...
// replaced grey palette with a sky palette (sky blues)
const sky = {
  50: "#f0f9ff",
  100: "#e0f2fe",
  200: "#bae6fd",
...
const StyledListbox = styled("ul")(
  ({ theme }) => `
      ...
      overflow: auto;
      outline: 0px;
      background: ${theme.palette.mode === "dark" ? sky[900] : "#fff"};
      border: 1px solid ${theme.palette.mode === "dark" ? sky[700] : sky[200]};
      color: ${theme.palette.mode === "dark" ? sky[300] : sky[900]};
      box-shadow: 0px 4px 30px ${theme.palette.mode === "dark" ? sky[900] : sky[200]};
      z-index: 1;
      `
);
...
const StyledMenuItem = styled(MenuItem)(
  ({ theme }) => `
      ...
      &.${menuItemClasses.focusVisible} {
        ...
        background-color: ${theme.palette.mode === "dark" ? sky[800] : sky[100]};
        color: ${theme.palette.mode === "dark" ? sky[300] : sky[900]};
      }
    
      &.${menuItemClasses.disabled} {
        color: ${theme.palette.mode === "dark" ? sky[700] : sky[400]};
      }
        ...
        <div className="flex gap-[10px] items-center transition-all">
          ...
          <Dropdown>
            <Tooltip title="More" arrow placement="top">
              <MenuButton>
                <PiDotsThreeOutlineThin className="cursor-pointer text-[23px] text-sky-500 hover:text-sky-700" />
              </MenuButton>
            </Tooltip>

            <Menu slots={{ listbox: StyledListbox }}>
              <StyledMenuItem
                className="text-sky-600 flex font-primary"
