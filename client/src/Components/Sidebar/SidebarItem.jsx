...
const SidebarItem = ({ item, child, openedMenu, setOpenedMenu, setShowSidebar }) => {
  ...
  return (
    <div
      ...
      <div
        className={`${child ? "pl-4 hover:text-sky-600 font-primary font-light" : "pl-4"} ${
          isMenuOpen
            ? "text-sky-600 font-primary font-medium border-l-[3px] border-l-sky-500"
            : " text-gray-700 font-light font-primary"
        } hover:text-sky-600 hover:border-l-[3px] hover:border-l-sky-500 pr-2 transition-all text-sm`}>
        <Link
          to={item?.link}
